...
struct ReportResponseDecodingTests {
    ...
    func typedStatisticsBranches() throws {
        let fixtures: [(WorkType, String, String)] = [
            ...
            (.pestControl, "pestControl", "\"categoryDistribution\":[],\"pesticideAmounts\":[{\"unit\":\"ml\",\"amount\":250.5,\"coverage\":{\"recordedCount\":1,\"targetCount\":1}}],\"categoryAmounts\":[],\"totalSprayAmountLiters\":20,\"sprayAmountCoverage\":{\"recordedCount\":1,\"targetCount\":1},\"targets\":[{\"target\":\"진딧물\",\"count\":1}]"),
