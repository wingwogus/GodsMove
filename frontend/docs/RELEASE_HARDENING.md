...
| 온보딩 | 생년월일 date picker — 최소한 오늘 이전까지만 선택 | 후순위 | 화면 독립 ✅ | 남음 |
| 온보딩 | 폴리곤 진입점 버튼 별도로 두기 | P1 | 화면 독립 ✅ | 남음 |
| 홈 | 날씨 UI 정렬 (홈·상세) | P1 | 화면 독립 ✅ | 남음 |
| 홈 | 최고·최저온도 날씨 미반영 문제 | P1 | 화면 독립 ✅ | 남음 |
| 검색 | 검색 인터랙션 개선 — 검색 후 단어 재탭 없이 바로 결과로 | P1 | 화면 독립 ✅ | 남음 |
| 기록 | (현재 없음) | - | - | - |
| 리포트 | 참참참 코칭 섹션 — 레이아웃 하단 잘림 | P0 | 화면 독립 ✅ | 남음 |
